...
#     segment_patches = np.array(segment_patches)[random_sample_indices].tolist()
    ...
    optimization_results_object_for_finding_transformation_matrix, initial_transformation_matrix = None #run_optimization_to_obtain_prior_transformation_matrix(combined_feature_vectors, labels)
