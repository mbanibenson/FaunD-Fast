...
#     embedded_feature_vectors = nca.transform(combined_feature_vectors)
    ...
    labels_with_support_set_as_one_class = np.concatenate([segmentation_feature_vectors, np.asarray([1]*len(support_set_feature_vectors_labels))
    
    return embedded_feature_vectors, background_feature_vectors, labels_with_support_set_as_one_class, combined_patches, optimization_results_object_for_finding_transformation_matrix, nca
