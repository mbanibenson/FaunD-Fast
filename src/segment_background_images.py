...
if __name__ == '__main__':
    ...
    list_of_training_patches, training_patch_names, training_patch_bboxes, training_patch_class_labels = segment_images_and_return_segments_as_list_of_ndarrays(file_paths)
