...
from visualization.manuscript_visualizations import generate_grid_view_of_megafauna_detected_by_faster_rcnn
from visualization.manuscript_visualizations import generate_grid_view_of_megafauna_from_pre_cropped_patches
...
if __name__ == '__main__':
    ...
    ### Generate grid vies of cropped detections
    ...
    grid_dimension_detections = 15
    
    #generate_grid_view_of_megafauna_detected_by_faster_rcnn(path_to_detections_summary_table, directory_to_save_manuscript_plots, grid_dimension_detections, figsize)
    
    generate_grid_view_of_megafauna_from_pre_cropped_patches(path_to_cropped_patches, directory_to_save_manuscript_plots, figsize=(4,4))
    ...
    generate_example_images_with_bounding_box_overlays(path_to_detection_summary_table, directory_to_save_manuscript_plots, figsize)
